...
public class Unit {
    ...
    public void move(String direction) {
        ...
        System.out.println(this.name + " 유닛이 " + direction + "쪽으로 이동했습니다. 현재 위치: " + this.position);
    }
    // 공격
    public void attack(Unit target) {
        if (target.getHp() <= 0) {
            ...
            System.out.println(this.name + "이(가) " + target.getName() + "을 공격했습니다.");

            int attackedHp = target.getHp() - this.damage;
            // 타겟의 hp를 감소시킴
